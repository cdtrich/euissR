#' width and height measurements for EUISS publications
#'
#' @format measurements (in mm) are stored in tibbles per type of publication. 
...
lwd_line <- 0.353 * 1.325   	# linewidth in mm * adjustment
